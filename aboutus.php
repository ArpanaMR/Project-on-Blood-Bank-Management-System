...
<div class="cont_main">
	<div class="content">
		<img src="Images/about.png" height="70px"  />
			...
			<p><img src="Images/123.jpg" height="200px" style="margin-bottom:40px" /></a>'A blood bank is a center where blood gathered as a result of blood donation is stored and preserved for later use in blood transfusion. The term "blood bank" typically refers to a division of a hospital where the storage of blood product occurs and where proper testing is performed (to reduce the risk of transfusion related adverse events). However, it sometimes refers to a collection center, and indeed some hospitals also perform collection.</p>
...
We remind every visitor that we have the empowerment to save lives and let’s do that – right now, right here. If you are eligible for blood donation, please register yourself as a blood donor now!</p>
		...
		<p class="top">thank you and please donate blood!</p>
        <p class="top"> Abhishikat kumar soni</p>
<p>Divyakriti Masum</p>
<p>Arpana </p>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
			<p class="title">rights reserved to abhishikat </p>
		</div>
	<div class="clear"></div>
</div>
</div>
